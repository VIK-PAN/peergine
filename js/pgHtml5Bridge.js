			...
			if (node != null) {
				if (js.OnFun == "OnExtRequest") {
					if (node.OnExtRequest != null) {
						...
						/*var sHtml = "<pre style={font-size:12px;word-wrap:break-word;word-break:break-all;white-space:normal;}>" + "来自机器人:" +sData + "</pre><br>";
						var ofrm1 = document.getElementById("msg_id");
						if (ofrm1) {
							ofrm1.insertAdjacentHTML("beforeEnd",sHtml);
						}*/
